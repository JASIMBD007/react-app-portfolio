        ...
        <div>
            ...
            <div className='md:block hidden fixed top-[25%] z-10'>
                <div className='flex flex-col'>
                    ...
                    <a onClick={handleNav} href="#education" className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-300 '>
                        <FaUniversity size={20} />
                    </a>
                    <a onClick={handleNav} href="#resume" className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-300 '>
                        <BsPerson size={20} />
                    </a>
                    <a onClick={handleNav}n href="#contact" className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-300 '>
                        <AiOutlineMail size={20} />
                    </a>
                </div>
            </div>
